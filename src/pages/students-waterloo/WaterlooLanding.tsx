...
export default function WaterlooLanding() {
    return (
        <ServiceLayout
            title="Students at Waterloo"
            subtitle="Dedicated immigration support for international students in the Waterloo region."
        ...
        >
            <div className="space-y-16">
                ...
                <section>
                    <h2 className="text-3xl font-bold text-gray-900 mb-10 text-center">Student Immigration Services (Waterloo)</h2>
                ...
                <section className="bg-abic-blue text-white p-10 rounded-3xl text-center">
                    <h3 className="text-2xl font-bold mb-4">Waterloo Office</h3>
                    <p className="text-lg mb-6">180 Northfield Dr W, Waterloo, ON</p>
